...
\pgfmathsetmacro{\pgfutil@tmpg}{TD("(\pgfutil@tmpb)-(\pgfutil@tmpa)o(\pgfutil@tmpb)-(\pgfutil@tmpa)")}%
\pgfmathsetmacro{\pgfutil@tmph}{2*TD("(\pgfutil@tmpa)-(\pgfutil@tmpc)o(\pgfutil@tmpb)-(\pgfutil@tmpa)")}%
\pgfmathsetmacro{\pgfutil@tmpi}{TD("(\pgfutil@tmpa)-(\pgfutil@tmpc)o(\pgfutil@tmpa)-(\pgfutil@tmpc)")-\pgfutil@tmpr*\pgfutil@tmpr}%
\pgfmathsetmacro{\pgfutil@tmpj}{\pgfutil@tmph*\pgfutil@tmph-4*\pgfutil@tmpg*\pgfutil@tmpi}%
...
\else
\pgfmathsetmacro{\pgfutil@tmpk}{(\pgfutil@tmph+sqrt(\pgfutil@tmph*\pgfutil@tmph-4*\pgfutil@tmpg*\pgfutil@tmpi))/2/\pgfutil@tmpg}%
\edef\pgfutil@tmpm{0}%
...
\ifnum\pgfutil@tmpf=3\relax% intersection between two lines, follow https://math.stackexchange.com/a/271366
 ...
 \else
  ...
  \pgfmathsetmacro{\pgfutil@tmph}{sqrt(TD("(\pgfutil@tmpH)o(\pgfutil@tmpH)"))}%
  \pgfmathsetmacro{\pgfutil@tmpk}{sqrt(TD("(\pgfutil@tmpK)o(\pgfutil@tmpK)"))}%
  ...
  \else
   \ifdim\pgfutil@tmpk pt<0.01pt\relax
	\PackageWarning{3dtools}{The lines do not intersect within the uncertainties. Returning (0,0,0) instead.}%
   \else
	\pgfmathsetmacro{\pgfutil@tmpl}{sign(TD("(\pgfutil@tmpH)o(\pgfutil@tmpK)"))*\pgfutil@tmph/\pgfutil@tmpk}%
