...
\tikzset{pics/3d/frustum/.style={code={%
  ...
  \ifnum\itest=0
   ...
   \pgfmathsetmacro{\pgfutil@tmpa}{sqrt(pow(x2d("-tdtmpo")-x2d("-tdtmpez"),2)+pow(y2d("-tdtmpo")-y2d("-tdtmpez"),2))}
   ...
   \else
	...
	\typeout{\aspectangle,\sdtip,\pgfutil@tmpa,\itest}%
	\path[overlay] (0,0,{sin(\aspectangle)}) coordinate (-tdtmpex);
