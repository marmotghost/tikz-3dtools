...
\else 
  ...
  \pgfmathtruncatemacro{\tikz@td@i}{TD("\pgfkeysvalueof{/tikz/3d/cylinder/axis}o(nscreenx,nscreeny,nscreenz)")>0?0:1}%
  \ifnum\tikz@td@i=0\relax 
    \pgfmathsetmacro{\tikz@td@ey}{TD("-1*(\tikz@td@ey)")}%
  \else
    %\pgfmathsetmacro{\tikz@td@ex}{TD("-1*(\tikz@td@ex)")}%
  \fi
  \pgfmathsetmacro{\tikz@td@ez}{TDunit("(\tikz@td@ex)x(\tikz@td@ey)")}%
  \expanded{\noexpand\path[overlay,
